...
try:
	...
	cetak(nel('\t• Installing bs4 module •'))
	os.system('install bs4')
try:
        import stdiomask
except ImportError:
...
try:
	...
	print('[[\x1b[1;92m•\x1b[1;97m] [\x1b[1;96mMr_Qureshi_xd')
...
███████║██║  ██║╚█████╔╝╚█████╔╝██║  ██║██████╔╝
╚══════╝╚═╝  ╚═╝ ╚════╝  ╚════╝ ╚═╝  ╚═╝╚═════╝ 
Facebook : https://m.me/Tera.Bap.Ka.Id.Hain                                               
AUTHOR :  SAJJAD
GITHUB I'D: SHAHZADA-AHMED
VERSION:0.01
TEAM:CYBER 71                                     
YouTube : HELP ZONE   
 '''
...
def menu(my_name,my_id):
	...
	gh = 'github.com/Aggressivejonty009'
...
def dump_massal():
	try:
		...
		exit()
	try:
		jum = int(input('├──> Apni marzi ke hisab se id add kardo  ? : '))
	except ValueError:
	...
	for met in range(jum):
		yz+=1
		kl = input('├──>  target id number daalo '+str(yz)+' : ')
		uid.append(kl)
	for userr in uid:
		try:
